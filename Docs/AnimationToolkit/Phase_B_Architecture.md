...
| `StitchPunk.AnimationToolkit.Tests.PlayMode` | Runtime, Authoring, UnityEngine.TestRunner, Unity.Entities, Unity.Entities.Hybrid, Unity.Collections, Unity.Mathematics, Unity.Mathematics.Extensions, Unity.Burst, Unity.Transforms | **[]** (amendment A25, superseding A17) | World/system integration tests (§11). |
...
**Amendment A25 (C3 Gate 4, 2026-08-01 — ⚠ recorded WITHOUT the owner present; supersedes A17's platform cell. Ratify or revert).** `Tests.PlayMode`'s `includePlatforms` is `[]`, not `["Editor"]`.
