...
public class GridSystemDebug : MonoBehaviour {
    ...
    public void UpdateGrid(GridSystem.GridSystemData gridSystemData, GridSystem.GridDataArrays gridDataArrays) {
    ...
    private void UpdateGridCostMapOnly(GridSystem.GridSystemData gridSystemData, GridSystem.GridDataArrays gridDataArrays) {
        for (int x = 0; x < gridSystemData.width; x++) {
            for (int y = 0; y < gridSystemData.height; y++) {
                GridSystemDebugSingle gridSystemDebugSingle = gridSystemDebugSingleArray[x, y];
