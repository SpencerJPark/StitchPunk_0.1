...
// /// </summary>
// public class InteractionRuntimeDebugDrawer : MonoBehaviour
// {
//     [Header("Settings")]
...
//                 ComponentType.ReadOnly<Interaction>(),
...
//                 Interaction interaction = entityManager.GetComponentData<Interaction>(waypointEntity);
...
//                     Gizmos.DrawWireSphere(position, interaction.broadcastRadius);
//                 }
//
//                 if (showInteractionRange)
//                 {
//                     Gizmos.color = interactionColor;
//                     Gizmos.DrawWireSphere(position, interaction.interactionRange);
//                 }
//             }
//
