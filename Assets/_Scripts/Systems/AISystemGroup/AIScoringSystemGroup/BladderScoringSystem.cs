...
public partial struct BladderScoringSystem : ISystem
{
    private const MotivationType MOTIVATION_TYPE = MotivationType.Bladder;

    private ComponentLookup<InteractionProvider> interactionProviderLookup;
    private ComponentLookup<LocalTransform> transformLookup;
    private ComponentLookup<BladderInteraction> bladderInteractionLookup;
    ...
    public void OnCreate(ref SystemState state)
    {
        ...
        bladderInteractionLookup = state.GetComponentLookup<BladderInteraction>(true);
    }
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        bladderInteractionLookup.Update(ref state);
        ...
        state.Dependency = new BladderScoringJob
        {
            interactionProviderLookup = interactionProviderLookup,
            transformLookup = transformLookup,
            bladderInteractionLookup = bladderInteractionLookup,
    ...
    public partial struct BladderScoringJob : IJobEntity
    {
        ...
        [ReadOnly] public ComponentLookup<BladderInteraction> bladderInteractionLookup;
        ...
        public void Execute(
            ...
            in BladderMotivation bladderMotivation,
