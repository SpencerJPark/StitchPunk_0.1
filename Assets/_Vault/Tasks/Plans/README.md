...
| **Animation Layers Content** (AL: the five missing rig layers, face targets, Idle/Attack/Blink clips, unit-SO clip wiring, assignment fallback fix, cutscenes onto Override) | [AnimationLayersContent_System.md](../NewPlans/AnimationLayersContent_System.md) | ✅ spec written 2026-09-07 — nothing built; Sonnet-executed, ⏸ owner checkpoint at T10 |
