...
| **Cutscene Acceptance** (G3: the "Rendezvous and Depart" cutscene authored with real assets + `verify-cutscene.md`) | [CutsceneAcceptance_System.md](../NewPlans/CutsceneAcceptance_System.md) | ✅ spec ready — last before the docs pass |
