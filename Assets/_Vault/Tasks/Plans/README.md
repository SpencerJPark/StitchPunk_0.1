...
| **Cutscene Profile Cutover** (G6: `CutsceneRequest.layerIndex` gone, assignment gated on `CutsceneActor`, facing-snap parity fixture, seven cutscene assets re-pointed at `MaleCitizen.profile` by script, F9 acceptance with walking minions) | [CutsceneProfileCutover_System.md](../NewPlans/CutsceneProfileCutover_System.md) | ✅ spec written 2026-09-08 — needs toolkit A73 (`Docs/AnimationToolkit/Amendment_A73_ProfileDrivenCutscenes_Spec.md`, two sessions) first |
