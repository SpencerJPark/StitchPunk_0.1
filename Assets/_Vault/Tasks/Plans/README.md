...
| **Actor Profile Cutover** (G5: `UnitSO` → profile, name-convention binding, assignment by name, `ActorFacing`, deletes `DirectionSetBlob`/`AnimationToolkitLayer`, authors the first profile) | [ActorProfileCutover_System.md](../NewPlans/ActorProfileCutover_System.md) | ✅ spec written 2026-09-07 — needs A70 + A71 first; ⏸ owner checkpoint at P10 |
...
| **Ragdoll Bodies + Death Tuning** (RG: eleven ragdoll bodies on `NewRig`, baked `RagdollLaunch`, torque-axis + mass-scaling fix, preview/in-game/revive verification, launch tuning) | [RagdollTuning_System.md](../NewPlans/RagdollTuning_System.md) | ✅ spec written 2026-09-07 — nothing built; supersedes `verify-ragdoll2d.md`; ⏸ owner checkpoint at T10 |
