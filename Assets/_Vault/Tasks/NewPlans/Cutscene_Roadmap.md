...
| A66 | ✅ **T1–T6 done 2026-09-06, awaiting the owner’s eyes.** [`Amendment_A66_CutsceneEditorPolish1_Spec.md`](../../../../Docs/AnimationToolkit/Amendment_A66_CutsceneEditorPolish1_Spec.md) | Auto Key, multi-select / box-select / copy-paste across lanes, easing curve editor for cutscene keys | A65 | G2 |
