...
| `_Scripts/Editor/` | [Editor.md](_Vault/Memories/Code/Editor.md) | Editor windows + inspectors: GraphView patterns, Texture Channel Packer, texture-array/painterly generators |
