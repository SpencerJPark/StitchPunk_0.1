#ifndef DOTS_ANIMATION_TOOLKIT_BILLBOARD_INCLUDED
#define DOTS_ANIMATION_TOOLKIT_BILLBOARD_INCLUDED
...
float3 ToolkitBillboardFacing(float mode, float3 pivotWS, float3 cameraPositionWS, float3 cameraForwardWS)
{
    ...
    // This is the classic 2.5D look and what the Spencer Park host shipped (A39); it is a
...
#endif // DOTS_ANIMATION_TOOLKIT_BILLBOARD_INCLUDED
