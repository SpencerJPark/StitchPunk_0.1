...
{
    /// <summary>
    /// Remembers the last folder a rig was saved to and resolves safe asset paths for new ones.
    /// </summary>
    public sealed class RigSaveLocation
    {
        public const string PrefsKey = "DotsAnimationToolkit.Rigs.SaveFolder";
        public const string DefaultAssetName = "NewRig";
