...
namespace DotsAnimationToolkit.Tests.EditMode
{
    ...
    public sealed class PackagingConformanceTests
    {
        ...
        public void Supplementary_PackageManifest_MatchesSection11Identity()
        {
            ...
            // -- not drift because someone edited the manifest. 0.22.0 is the Clip Sets tab: browse,
            // create and edit clip sets without leaving the Clip Editor.
            Assert.AreEqual("0.22.0", manifest.version, "Version tracks the shipped feature set; 0.22.0 is the Clip Sets tab.");
