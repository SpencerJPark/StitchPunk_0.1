...
namespace DotsAnimationToolkit.Tests.EditMode
{
    ...
    public sealed class PackagingConformanceTests
    {
        ...
        public void Supplementary_PackageManifest_MatchesSection11Identity()
        {
            ...
            // -- not drift because someone edited the manifest. 0.23.0 is the Rigs tab: a rig
            // catalog beside a target list that edits the selected rig in place.
            Assert.AreEqual("0.23.0", manifest.version, "Version tracks the shipped feature set; 0.23.0 is the Rigs tab.");
